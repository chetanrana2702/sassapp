...
ActiveRecord::Schema.define(version: 20180118063757) do
  ...
  create_table "discounts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text "name_translations", default: "'\"{}\"'", null: false
    t.integer "coupon_code", limit: 2, default: 0, null: false
    t.integer "in_percentage", default: 0
    t.decimal "in_price", precision: 6, scale: 2, default: "0.0"
    t.boolean "status", default: false, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "manage_subscription_months", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "subscription_id", null: false
    t.text "plan_name_translations", default: "'\"{}\"'", null: false
    t.integer "month_number", limit: 1, default: 0, null: false
    t.integer "total_months", limit: 1, default: 0, null: false
    t.decimal "actual_plan_price", precision: 6, scale: 2, default: "0.0", null: false
    t.integer "coupon_code", limit: 2, default: 0, null: false
    t.integer "discount_in_percnt", limit: 1
    t.decimal "discount_fixed_amount", precision: 6, scale: 2, default: "0.0"
    t.decimal "discounted_price", precision: 6, scale: 2, default: "0.0", null: false
    t.decimal "total_price", precision: 6, scale: 2, default: "0.0", null: false
    t.timestamp "starts_on", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.timestamp "ends_on", null: false
    t.boolean "order_generated", default: false, null: false
    t.boolean "full_payment_received", default: false, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["subscription_id"], name: "index_manage_subscription_months_on_subscription_id"
  end

  create_table "orders", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "manage_subscription_month_id", null: false
    t.decimal "total_price", precision: 6, scale: 2, default: "0.0", null: false
    t.boolean "payment_status", default: false, null: false
    t.boolean "payment_mode", default: false, null: false
    t.bigint "transaction_unique_id", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["manage_subscription_month_id"], name: "index_orders_on_manage_subscription_month_id"
  end

  create_table "plans", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text "title_translations", default: "'\"{}\"'", null: false
  ...
  create_table "tenants", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["category_id"], name: "index_tenants_on_category_id"
    t.index ["db_uuid"], name: "index_tenants_on_db_uuid"
    t.index ["email"], name: "index_tenants_on_email"
    t.index ["firstname", "lastname"], name: "index_tenants_on_firstname_and_lastname"
    t.index ["subdomain"], name: "index_tenants_on_subdomain"
  end

  add_foreign_key "discounts", "plans"
  add_foreign_key "manage_subscription_months", "subscriptions"
  add_foreign_key "orders", "manage_subscription_months"
